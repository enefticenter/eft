...
/**
     ...
     ENEFTI CENTER is the MARKETPLACE for corporate, artists, actors, designers and musicians in the personal NFT ecosystem on Blockchain
     Domain Nft * Stake & Swap * Brigde to Polygon  & BSC *


telegram : https://t.me/enefticenter
...
contract ENEFTI is Context, IERC20, Ownable {
    ...
    string private _name = 'Enefti Center';
    string private _symbol = 'EFT';
